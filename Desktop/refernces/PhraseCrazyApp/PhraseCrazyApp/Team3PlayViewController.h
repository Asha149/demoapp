...
@interface Team3PlayViewController : UIViewController  <UIAlertViewDelegate,AVAudioPlayerDelegate>
{
     NSTimer *timer;
...
@property (nonatomic,retain)IBOutlet UILabel *lblScore1,*lblScore2,*lblScore3;
