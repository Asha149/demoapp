...
@synthesize selectedIndex, isHorizontal, animationDuration, animationCurve,scrollView;
...
- (void)touchDown:(id)sender {
    if (allowsMultipleSelection)
    {
        ...
        if ([selectionIndexes containsIndex:[sender tag]]) {
            ...
            [sender setBackgroundImage:[UIImage imageNamed:@"accordian.png"] forState:UIControlStateNormal];
        } else {
            [mis addIndex:[sender tag]];
            [sender setBackgroundImage:[UIImage imageNamed:@"accordian_hover.png"] forState:UIControlStateNormal];
        }
...
//            [btn setBackgroundImage:[UIImage imageNamed:@"sellbutton.png"] forState:UIControlStateNormal];
//        }
//        else{
//            [btn setSelected:TRUE];
//            [btn setBackgroundImage:[UIImage imageNamed:@"sell_title.png"] forState:UIControlStateNormal];
//        }
